            ...
            <main className="w-full lg:w-2/3 flex-1 flex flex-col items-center justify-center p-4 sm:p-8">
                <div className="w-full max-w-sm flex flex-col items-center">
                    ...
                    <div className="flex items-center justify-center space-x-8 mt-4">
                         <button onClick={onPrev} disabled={playlist.length === 0} className="p-2 text-slate-300 hover:text-white disabled:opacity-50"><SkipBackIcon className="w-8 h-8"/></button>
                        <button 
                            onClick={onPlayPause} 
                        ...
                        <button onClick={onNext} disabled={playlist.length === 0} className="p-2 text-slate-300 hover:text-white disabled:opacity-50"><SkipForwardIcon className="w-8 h-8"/></button>
                    </div>
                </div>
            </main>
                        ...
                        playlist.map((track, index) => (
                            <li key={index}>
                                <button
                                    ...
                                    className={`w-full text-left p-2 rounded-lg flex items-center space-x-4 transition-colors ${index === currentTrackIndex ? 'bg-white/10' : 'bg-transparent hover:bg-white/5'}`}
                                >
