...
const InventoryCard: React.FC<{
  ...
  return (
    <div className="bg-slate-800 rounded-lg shadow-md p-4 flex flex-col justify-between">
      <div>
  ...
  return (
    <div className="p-4 md:p-8">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-3xl font-bold text-white">Inventário de Materiais</h2>
        <button
